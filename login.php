...
<body class="flex flex-col justify-center items-center content-center">
  ...
  <div class="container py-10">
    <div class="">
      <div
        class="border-2 border-solid bg-white border-black z-10 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
        ...
        <div class="flex flex-col justify-center items-center content-center pt-12">
          ...
          <form class="flex flex-col justify-center items-center content-center border-solid w-full" method="post" action="check_login.php">
            <input class="p-4 m-2 w-5/12 h-11 border-2 border-solid border-black" placeholder="Username" type="text"
              name="username">
            <input class="p-4 m-2 w-5/12 h-11 border-2 border-solid border-black" placeholder="Password" type="text"
              name="password">
      ...
      <div
        class="border-2 border-solid border-black z-0 mt-5 ml-5 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
        style="height: 500px; width: 900px;">
      </div>
    </div>
